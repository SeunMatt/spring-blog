...
<head>
    ...
    <title>Spring-Blog Confirm Email Address</title>
                                ...
                                <tr>
                                    <td style="background-color:#ffffff; padding-top: 15px;">
                                            ...
                                            <table style="margin:0 auto;" cellspacing="0" cellpadding="0" class="force-width-80">
                                                <tr>
                                                    <td style="text-align:left;">
                                                        ...
                                                        You request for a password reset. Use the link below to achieve that. If you did not initiate this request, kindly contact us.<br>
                                                        Thank you.
                                                    </td>
                                                </tr>
                                            </table>
                                        ...
                                        <table style="margin:0 auto;" cellspacing="0" cellpadding="10" width="100%">
                                            ...
                                            <tr>
                                                <td style="text-align:center; margin:0 auto;">
                                                    if the button above is not working, copy-paste this link to your browser
                                                    <br>
                                                    <a href="${link}">${link}</a>
                                                </td>
                                            </tr>
