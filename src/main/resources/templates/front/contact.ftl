...
<header class="intro-header" style="background-image: url('<@asset url='admin/images/default-post-picture.png'/>')">
    <div class="container">
        <div class="row">
...
<div class="container">
    <div class="row">
        <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
            ...
            <form role="form" action="/contact" id="contactForm" method="POST" novalidate>
